    ...
    // MARK: - iOS / macOS (grouped list)
        ...
        private var playlistsSection: some View {
            Section {
                ...
                if playlists.isEmpty {
                    ...
                    Text("Free includes one playlist. Upgrade to DBStream Pro to add more.")
                }
            }
        }
        ...
        private var playerSection: some View {
            Section {
                ...
                Text("DBStream plays each stream with your preferred engine and falls back to the next if it can't be played. Streams open in the selected external app instead, when one is installed.")
            }
        }
